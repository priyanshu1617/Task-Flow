...
- **Dedicated Intro & Login Flow**: A high-definition, immersive landing page with a 4K starry night and soft clouds aesthetic, followed by a sleek glassmorphic login interface featuring a premium futuristic 3D aesthetic.
...
[task-tracker-theta-nine-71.vercel.app](https://task-tracker-theta-nine-71.vercel.app)

To access the dashboard from the login page, please use the following credentials:
- **Username:** `studywithpriyanshu`
- **Password:** `studywithme12345`
